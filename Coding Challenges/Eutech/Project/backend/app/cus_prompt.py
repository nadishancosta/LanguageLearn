...
3. Handle Miss-spelled words
   - The queries may have incorrect spellings in the text. ONLY in these cases, make the best guess in relation to the data. Remember, only the data regarding Room 1, Room 2, Room 3 and Room 4 are available.
     Only the data regarding temperature, CO2 and Relative humidity (RH) can be asked.
